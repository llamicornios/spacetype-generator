...
function preload(){
  ...
  tFont[1] = loadFont("boost_resources/Milligram-Condensed-Bold.ttf");
  tFont[2] = loadFont("boost_resources/GT-America-Extended-Black-Trial.otf");
  tFont[3] = loadFont("boost_resources/GT-Alpina-Condensed-Light-Trial.otf");
  tFont[4] = loadFont("boost_resources/NeueWorld-CondensedRegular.ttf");
  tFont[5] = loadFont("boost_resources/FormulaCondensed-Black.otf");
  tFont[6] = loadFont("boost_resources/InstrumentSerif-Italic.ttf");
  // tFont[7] = loadFont("boost_resources/Zaatar-Bold.otf");
  tFont[7] = loadFont("boost_resources/Ko_Banzeen-SlantedL.otf");
  tFont[8] = loadFont("boost_resources/ZafranArabic-Black.otf");
